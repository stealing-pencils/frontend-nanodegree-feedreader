...
## To Run The Feedreader Test

1. Fork or download this project from github
2. Open index.html on you Browser
3. Review the jasmine test by scrolling to the bottom of the page
